...
import { isCPF, isCNPJ, formatToBRL, formatToCPF, formatToRG, formatToPhone, formatToCEP, formatToCNPJ } from 'brazilian-values';
...
var isCPF$1 = function (value) { return is(value, 'String') && isCPF(value); };
/**
...
var isCNPJ$1 = function (value) { return is(value, 'String') && isCNPJ(value); };
/**
...
var toCPF = formatForType('String', formatToCPF);
/**
...
var toRG = formatForType('String', function (value) { return formatToRG(value, 'SP'); });
/**
...
var toMoney = formatFor(function (value) { return is(value, 'Number') || is(value, 'String') && !isNaN(value); }, formatToBRL);
/**
...
var toPhone = formatForType('String', formatToPhone);
/**
...
var toCEP = formatForType('String', formatToCEP);
/**
...
var toCNPJ = formatForType('String', formatToCNPJ);
