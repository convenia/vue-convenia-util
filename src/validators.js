...
import { isCPF as validateCPF, isCNPJ as validateCNPJ } from 'brazilian-values'
 ...
 * @returns {Boolean}
 */
export const isCPF = (value) => is(value, 'String') && validateCPF(value)
 ...
 * @returns {Boolean}
 */
export const isCNPJ = (value) => is(value, 'String') && validateCNPJ(value)
